  ...
  return (
    ...
    >
      ...
      >
        ...
        <Cartao>
          <Text style={styles.tituloCartao}>Resultado geral</Text>
        ...
        <Cartao>
          ...
          <Text style={styles.explicacao}>
            Anote quantas questões acertou em cada matéria, pra ter uma base real de onde está mais
            fraco nos simulados.
          </Text>
        ...
        <Botao titulo="Salvar simulado" onPress={salvarResultado} />
        ...
        <Cartao style={{ marginTop: 14 }}>
          ...
          {historico.map((item) => {
            ...
            return (
              <View key={item.id} style={styles.linhaHistorico}>
